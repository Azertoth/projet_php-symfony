...
class Site
{
    ...
    /**
     * @ORM\OneToMany(targetEntity=Particpant::class, mappedBy="site")
     */
    ...
    public function addParticipant(Particpant $participant): self
    {
    ...
    public function removeParticipant(Particpant $participant): self
    {
